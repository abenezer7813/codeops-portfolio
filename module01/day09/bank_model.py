...
class AccountRegistry:
    ...
    def total_transactions(self, number):
        ...
        def _sum_recursive(tx_history):
            if not tx_history:
                return 0
            return tx_history[0][1] + _sum_recursive(tx_history[1:])
...
region = Branch("Central Region")
branch1 = Branch("Bole Branch")
branch2 = Branch("Kazanchis Branch")

head_office.children.append(region)
region.children.append(branch1)
region.children.append(branch2)

branch1.accounts.append(account1)
branch1.accounts.append(account2)
branch2.accounts.append(saving_account)
head_office.accounts.append(current_account)
